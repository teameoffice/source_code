...
<html lang="en">
    ...
    <body>
		...
		<main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title">Update Kategori</div>
                    </div>
                                    ...
                                    <form class="col s12" action="" method="post">
                                        <div class="row">
                                            <div class="input-field col s6">                                               
                                                <input placeholder="Nama Alur" id="nama_kategori" type="text" class="validate" name="nama_kategori" value="<?php echo $kategori->nama_kategori; ?>">
                                                <label for="nama">Nama Kategori</label>
                                            </div>
                                        </div> 
                                            <div class="input-field col s6">                                               
                                                <input placeholder="Deskripsi" id="deskripsi" type="text" class="validate" name="deskripsi" value="<?php echo $kategori->deskripsi; ?>">
