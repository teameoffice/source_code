...
<html lang="en">
    ...
    <body>
        <?php  $this->load->view("front/common/common_loader"); ?>
...
<!--                                     <ul>
                                ...
                                <span class="card-title"><a href="<?php echo site_url("suratmasuk/"); ?>">
                                     Surat Masuk</a></span>
...
<!--                                     <ul>
                                ...
                                <span class="card-title"><a href="<?php echo site_url("suratkeluar/"); ?>">
                                     Surat Keluar</a></span>
