...
class Suratkeluaradmin extends CI_Controller {
	...
	public function index()
	{
		if(_is_user_login($this)){
            ...
            $data["distinct"] = $this->dokumen_model->get_dokumen_distinct_suratkeluar_uniq();
            
            $this->load->view("suratkeluaradmin/index",$data);
        }
    }
